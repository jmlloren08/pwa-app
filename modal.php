  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <form method="POST" action="edit.php">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="txtdatafname" name="txtdatafname" aria-describedby="inputGroupPrepend" required>
              </div>
            </div>
            <div class="row">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-bs-submit="edit.php">Save changes</button>
      </div>
    </div>
  </div>
</div>
